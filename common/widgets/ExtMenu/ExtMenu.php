<?php
namespace common\widgets\ExtMenu;
...
class ExtMenu extends Menu
{
     ...
     * In this template, the token `{show}` will be replaced with "style='display:block;'" or "style='display:none;'".
     */
